...
ci.innerHTML=`<input type="date" id="cid"  min="${year}-0${month}-${day}" value="${year}-0${month}-${day}">`
...
co.onchange=()=>{
    ...
    search.onclick=()=>{
        ...
        localStorage.setItem("date",JSON.stringify(dit))
